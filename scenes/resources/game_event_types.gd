...
const CUSTOM_MANSION_2_MOVING_WALL_DOOR_CHAIN_TRIGGERED := &"custom_mansion_2_moving_wall_door_chain_triggered"
const CUSTOM_BLUEBERRY_FARM_CHASE_SEQUENCE := &"custom_blueberry_farm_chase_sequence"